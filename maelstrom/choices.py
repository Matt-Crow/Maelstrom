...
class ChooseOneOf[T]:
    ...
    def __init__(self, options: list[T], callback: Callable[[T], None]):
...
class ChooseOneOrNone[T, U]:
    ...
    def __init__(self, options: list[T], none_of_these: U, handle_choice: Callable[[T], None], handle_none: Callable[[], None]):
        self._options = options
...
class ChooseAction:
    ...
    def __init__(self, action_mappings: list[ActionMapping]):
